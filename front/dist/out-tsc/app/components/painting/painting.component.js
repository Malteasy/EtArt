...
function PaintingComponent_span_0_Template(rf, ctx) { if (rf & 1) {
    const _r8 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "span", 4)(1, "button", 5);
    i0.ɵɵlistener("click", function PaintingComponent_span_0_Template_button_click_1_listener($event) { const restoredCtx = i0.ɵɵrestoreView(_r8); const year_r6 = restoredCtx.$implicit; const ctx_r7 = i0.ɵɵnextContext(); return ctx_r7.onClick(year_r6.key, $event); });
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function PaintingComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "div");
} }
function PaintingComponent_ng_template_3_Template(rf, ctx) { }
function PaintingComponent_ng_template_5_Template(rf, ctx) { if (rf & 1) {
...
export class PaintingComponent {
    ...
    ngOnInit() {
        this.imageService.getImagesByType("painting").subscribe((response) => {
...
PaintingComponent.ɵfac = function PaintingComponent_Factory(t) { return new (t || PaintingComponent)(i0.ɵɵdirectiveInject(i1.ImageLoadService), i0.ɵɵdirectiveInject(i2.ImagesService)); };
PaintingComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PaintingComponent, selectors: [["app-painting"]], decls: 7, vars: 6, consts: [["class", "img-inline", 4, "ngFor", "ngForOf"], [4, "ngIf", "ngIfThen", "ngIfElse"], ["nullBlock", ""], ["imgBlock", ""], [1, "img-inline"], ["type", "button", 1, "btn", "btn-outline-dark", "btn-lg", 3, "id", "click"], [1, ""], [3, "year", "images"]], template: function PaintingComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵtemplate(0, PaintingComponent_span_0_Template, 3, 2, "span", 0);
        i0.ɵɵpipe(1, "keyvalue");
        i0.ɵɵtemplate(2, PaintingComponent_div_2_Template, 1, 0, "div", 1);
        i0.ɵɵtemplate(3, PaintingComponent_ng_template_3_Template, 0, 0, "ng-template", null, 2, i0.ɵɵtemplateRefExtractor);
        i0.ɵɵtemplate(5, PaintingComponent_ng_template_5_Template, 2, 2, "ng-template", null, 3, i0.ɵɵtemplateRefExtractor);
    } if (rf & 2) {
